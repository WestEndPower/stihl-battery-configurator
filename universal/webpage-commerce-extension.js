(function(){
  ...
  function renderFamilyPrices(f){
    ...
    if(tool){
      out+='<div class="wep-price-choice wep-tool-choice"><span class="wep-choice-kicker">FLEXIBLE</span><p><span>Tool Only</span><strong>'+dollar+Number(tool.price||0).toFixed(2)+'</strong></p>';
    ...
    if(kit){
      out+='<div class="wep-price-choice wep-kit-choice"><span class="wep-choice-kicker">BEST VALUE</span><p><span>Package / Kit</span><strong>'+dollar+Number(kit.price||0).toFixed(2)+'</strong></p>';
