(function(){
  ...
  function absoluteImage(raw){
    ...
    return 'https://westendpower.github.io/stihl-battery-configurator/' + raw;
  }
  function configureUrl(item,category){
    var sku=clean(item && item.SKU);
    var base='https://westendpower.github.io/stihl-battery-configurator/';
    try{
      ...
      '<div class="wep-card-main">'+
        ...
        '<section class="wep-card-left">'+
          '<div class="wep-smart-media">'+
            ...
            '</a>'+
          '</div>'+
          (first.details && /^https?:\/\//i.test(first.details) ? '<a class="wep-external-details" href="'+esc(first.details)+'" data-product-details="'+esc(f.key)+'" data-wep-external="1" target="_blank" rel="noopener noreferrer">Product Details <span aria-hidden="true">â†—</span></a>' : '')+
        '</section>'+
