      ...
      '<div class="wep-smart-body">'+
        ...
        '<div class="wep-smart-actions">'+
          ...
          (clean(f.power).toUpperCase()==='BATTERY'
            ? '<a href="'+esc(first.configure||'#')+'" data-runtime="'+esc(f.key)+'">Battery Runtime &amp; Charge Times</a>'
            : '')+
